#################################################################################
# This experiment implements a Block Neural Autoregressive Flow (BNAF) with a mixture of Gaussians with multiple components  
# to approximate a mixture of Gaussians target. 
...
class Flow:
    ...
    # build BNAF on a base of mixture of Gaussians, apply bounding transforms to get variational distribution
    def default_flow(
        self,
        key,
        *,
        ...
        **kwargs,
        ...
        Parameters to be specified for the flow training:
...
class Runner:
    ...
    def __init__(self, base_results_dir: str = "./results", save: bool = True):
        ...
        # ------------------------------------------------------------------------
        # define parameters for VI sampler
        # ------------------------------------------------------------------------
        np.random.seed(900)
        ...
        # --------------------------------------------------------------------------
        # define variational inference runner
        # --------------------------------------------------------------------------    
